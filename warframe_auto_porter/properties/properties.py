...
def get_root_value(self):
    ...
    ].preferences.root_preference


def set_root_value(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.root_preference = value
...
def set_rig_value(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.rig_preference = value
...
def get_ext_value(self):
    val = bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.texture_extension_preference
...
def set_ext_value(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.texture_extension_preference = texture_extension_list[value][0]


def get_extractor_path(self):
    return bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.extractor_path_preference


def set_extractor_path(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.extractor_path_preference = value


def get_cache_path(self):
    return bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.cache_path_preference


def set_cache_path(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.cache_path_preference = value


def get_shader_library_path(self):
    return bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.shader_library_path_preference


def set_shader_library_path(self, value):
    bpy.context.preferences.addons[
        __package__.rpartition(".")[0]
    ].preferences.shader_library_path_preference = value
...
class WarframeAddonProperties(bpy.types.PropertyGroup):
    ...
    bake_normal: BoolProperty(name="Normal", default=False)
    ...
    bake_height: IntProperty(name="Height", description="Height of the baked texture", default=2048)
    bake_width: IntProperty(name="Width", description="Width of the baked texture", default=2048)
    ...
    subdiv_amount: IntProperty(
        name="Subdivision Amount", description="Subdivision Amount", default=4
    )
    optimized_subdivision: BoolProperty(name="Use Simple + Catmull-Clark", default=False)
    ram_subdivision: BoolProperty(
        name="Use Ram Amount To Guess Amount Of Subdivisions", default=False
    )
    ram_amount: IntProperty(name="Ram Amount (GB)", default=8)
    separate_mode: BoolProperty(name="Separate Stages", default=False)
    image_select: bpy.props.EnumProperty(
        name="Height Map", description="Select an image from the blend file", items=get_image_items
    )
    ...
    bake_output_path: bpy.props.StringProperty(name="Bake Output", subtype="DIR_PATH", default="")
    mode: EnumProperty(
        name="Mode",
